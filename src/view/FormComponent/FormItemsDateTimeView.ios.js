...
import ModalCalendar from "../Component/DatePicker";
...
export default class FormItemsDatePickerView extends React.Component{
  ...
  getDateChange(data){
    ...
    let dformat = [d.getFullYear(),
                  ...
                  d.getDate()>9?d.getDate():`${0}${d.getDate()}`].join('-')+' '+[d.getHours(),d.getMinutes() > 10?d.getMinutes():"0"+d.getMinutes()].join(':');
  ...
  render() {
    ...
    var ColoredFlatButton = MKButton.coloredFlatButton()
      ...
      .withOnPress(() => {
      _this.props.refs.datapicker.refs.modal.show(_this);
    }).build();
