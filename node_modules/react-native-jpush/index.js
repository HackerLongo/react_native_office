...
export default class JPushNotification {
    ...
    static setBadgerNumber(badgerNumber : number){
        nativeModule.setBadgerNumber(badgerNumber)
    }

    static changeBadgerNumber(type : number){
        nativeModule.changeBadgerNumber(type)
    }
