...
import com.zooma.badger.ShortcutBadger;
...
public class JPushModule extends ReactContextBaseJavaModule {
    ...
    private static int badgerNumber = 0;
...
//        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    public void setBadgerNumber(int number) {
        ShortcutBadger.with(getReactApplicationContext()).count(number);
        badgerNumber = number;
    }

    @ReactMethod
    public void changeBadgerNumber(int type) {
		if(type == 0)
			badgerNumber += 1;
		else if(type == 1)
			badgerNumber -= 1;
        ShortcutBadger.with(getReactApplicationContext()).count(badgerNumber);
    }
    ...
    public static class JPushReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean isAppForeground = _isAppForeground(context);
            ...
            if(JPushInterface.ACTION_NOTIFICATION_RECEIVED.equals(intent.getAction())){
                ...
                if (extras != null) {
                    try {
                        ...
                        badgerNumber = object.optInt("todoNumber");
...
//                if(!isAppForeground) {
//                    badgerNumber++;
                    ShortcutBadger.with(context).count(badgerNumber);
                }
            }
            if (isAppRunning) {
		...
		private boolean isAppRunning(Context context) {
			...
			String MY_PKG_NAME = "com.zqoffice";
...
//                    }
        ...
        private boolean _isAppForeground(Context context) {
            ActivityManager activityManager = (ActivityManager) context.getApplicationContext().getSystemService(context.ACTIVITY_SERVICE);
            List<ActivityManager.RunningAppProcessInfo> processInfos = activityManager.getRunningAppProcesses();
            for (ActivityManager.RunningAppProcessInfo processInfo : processInfos) {
                if (processInfo.processName.equals(context.getApplicationContext().getPackageName())) {
